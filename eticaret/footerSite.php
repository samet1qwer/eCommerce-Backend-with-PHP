        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul class="contact-widget">
                    <li class="fphone"><?php echo $ayar_getir['ayar_tel']; ?> <br>
                        <?php echo $ayar_getir['ayar_faks']; ?></li>
                    <li class="fmobile"><?php echo $ayar_getir['ayar_gsm']; ?><br><?php echo $ayar_getir['ayar_gsm']; ?>
                    </li>
                    <li class="fmail lastone"><?php echo $ayar_getir['ayar_mail']; ?></li>
                </ul>
            </div>
            <!--footer contact widget-->
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <!--footer nav-->
                <div class="f-credit">&copy;<?php echo $ayar_getir['ayar_author'] ?> <a href="#"> example.com </a></div>
                <a href="">
            ...
            <div class="col-md-3">
                ...
                <div class="fsoc">
                    <a href="http://<?php echo $ayar_getir['ayar_twitter'] ; ?>" class="ftwitter">twitter</a>
                    <a href="http://<?php echo $ayar_getir['ayar_facebook'] ; ?>" class="ffacebook">facebook</a>
                    <a href="http://<?php echo $ayar_getir['ayar_youtube'] ; ?>" class="fflickr">flickr</a>
                    <a href="http://<?php echo $ayar_getir['ayar_google'] ; ?>" class="ffeed">feed</a>
                    <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
            </div>
