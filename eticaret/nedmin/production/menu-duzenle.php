            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="" id="first-name" name="kullanici_tc" disabled=""
                                        value="<?php echo $ayarcek['ayar_url'] ?>/sayfa-<?php echo seourl($menucek['menu_ad']) ?>"
                  ...
                  -->
                                        ...
                                        <option value="1"
                                            <?php echo $menucek['menu_durum'] == '1' ? 'selected=""' : ''; ?>>Aktif
                                        </option>



                                        <option value="0"
                                            <?php if ($menucek['menu_durum']==0) { echo 'selected=""'; } ?>>Pasif
                                        </option>
                                        <!-- <?php 
