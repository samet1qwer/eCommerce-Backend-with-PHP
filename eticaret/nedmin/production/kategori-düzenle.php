                    ...
                    <div class="x_content">
                        ...
                        <form action="../../netting/işlem.php" method="POST" class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="" id="first-name" name="kategori_ust"
                                        value="<?php echo $kategoricek['kategori_ust']; ?>" required="required"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <input type="number" name="kategori_id" value="<?php echo $_GET['id']; ?>" hidden>
                            ...
                            <!-- <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">kategori Detay
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    <textarea class="ckeditor" id="editor1"
                                        name="kategori_detay"><?php ; ?></textarea>
                                </div>
                            </div> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="kategori_seourl"
                                        value="<?php echo $kategoricek['kategori_seourl'] ?>"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                   ...
                   ?>
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="kategoriduzenle"
